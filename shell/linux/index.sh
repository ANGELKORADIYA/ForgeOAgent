...
SELECTED_TYPE=$(echo "$PROMPT_TYPES" | zenity --list --column="Prompt Types" --title="Select Prompt Type" --height=300)
...
if [ $? -eq 0 ]; then
    ...
    notify-send "Success" "Prompt processed and copied to clipboard"
else
